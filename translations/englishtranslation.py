class language():
  ...
  sparrow = '[white]CataTech BIOS.[not bold]v1.0[/not bold][/white] - [bright_yellow]Energy Star (un)Powered[/bright_yellow]'
  # {0} is for the build verson, {1} is for the compile date.
  version = '[white]M95 ver. [bold]{0}[/bold] - compiled {1}[/white]'
  dev = '[bold red]- Stable Build // Minimal Bugs-[/bold red]\n\n'
  ...
  credits1 = "Mail[#12cc00]95[/#12cc00] [blink]Development[/blink] and [blink]Contributor[/blink] Team"
  credits2 = "Mail[#12cc00]95[/#12cc00] [blink]Translation[/blink] Team"
  ...
  closeCMD = '[bold yellow]It is now safe to close your Command Prompt.[/bold yellow]'
  bm1 = 'M e n u'
  bm2 = 'New Game'
  bm3 = 'Load Game'
  bm4 = 'Restart'
  ...
  level = 'Level'
  oneLifeLeft = "You have [italic bright_red]1 life left![/italic bright_red]. Be careful, its your last chance."
  # {0} is the current number of lives.
  livesLeft = "You have {0} lives left."
  pressInstructions = "Type 'c' to catch, any other key to avoid, and 'q' to quit.\n"
  ...
  expertAcquired = '\nProfessional Label acquired!'
  masterAcquired = '\nMaster Label acquired!'
  adeptAcquired = '\nWorld Class Label acquired!'
  grandAcquired = '\nGod of the game Label acquired!'
  whatAcquired = '\nMeme based.'
