...
def startup(sa):
    ...
    clear()
    print('M a i l 9 5 ', systemarray[4])
    print(systemarray[3])
    print(lang.loading)
    sleep(5)
    ...
    while True:
        ...
        if progressbar >= 100:
            ...
            if systemarray[1] == 100:
                ...
                systemarray[3] = "World Class"
            elif systemarray[1] == 5000:
                print(lang.grandAcquired)
                systemarray[3] = "God of the game"
            elif systemarray[1] == 69420:
                print(lang.whatAcquired)
                systemarray[3] = "Meme based."
